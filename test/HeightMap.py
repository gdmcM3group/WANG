...
# output:input shape
 ...
 # def getHeightMap
# input: self
# output:input hight_map
    def getHeightMap(self):
        return self.height_map
# def getWaterBlocks
# input: self
# output:input water blocks
    def getWaterBlocks(self):
        return self.water_blocks
# def getHeight_map_gradient_X
# input: self
# output:gradient of X,In other words, know how much the terrain changes
    def getHeight_map_gradient_X(self):
        return self.height_map_gradient_X
# def getHeight_map_gradient_Z
# input: self
# output:gradient of Z,In other words, know the steepness of the mountain
    def getHeight_map_gradient_Z(self):
        return self.height_map_gradient_Z
# def get_height_map_norm
# input: self
# output:height of map
    def get_height_map_norm(self):
        return self.height_map_norm
# def calculat
# input: self
# Get the height of the map by looping
    def calculate(self):
...
# def calculateSurfacePointHeight
# input: self, level, x, z（int）
# return:y
# Determine whether the terrain can be high to get y
    ...
    def isSurfaceBlock(self, level, x, y, z):
        ...
        for block in self.aboveSurfaceBlocks:
            if level.blockAt(x, y, z) == block:
                return False
        return True
# def icalculate_gradient
# input :self
# Get the gradient of the map(X,Z) by looping
...
# def getHeight
# input :self x, z
# Get the height of the map(X,Z) if this block is exists
...
# def getNorm
# input :self x, z
# Get the norm of the map(X,Z) if this block is exists
