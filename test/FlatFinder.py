...
# def splitArea
# input :self
#to get split:area_list_x and self.area_list_z
    def splitArea(self):
...
# def calculateCandidatePoints
# input :self
#loop until end area_list_x and area_list_z
    ...
    def calculateCandidateAreas(self):
        ...
        for one_x_area in self.area_list_x:
            for one_z_area in self.area_list_z:
                ...
                area_index += 1
# def alculateOneCandidatePoint
# input :self, one_x_area, one_z_area(list)
# return :one_candidate_point
#loop get mean_norm and one_candidate_point
    def calculateOneCandidatePoint(self, one_x_area, one_z_area):
        ...
        return one_candidate_point
# def calculateOneCandidateArea
# input :self, one_x_area,, area_inde, one_z_area(list)
# return :m.getResult()=self.checked_list(MooreBeighborhood.py)
#can get more beighborhood
    def calculateOneCandidateArea(self, one_x_area, one_z_area, area_index):
        ...
        return m.getResult()
# def calculate_point_mean_norm
# input :self, index_xz(list)
# return :mean_norm
#get list mean_norm
...
# def mergeAllArea
# input :self
# get area is waters or flat blocks
...
# input :self, x, z(int)
# output :checked_list2
# check unchek_list >0 or not
...
# def checkStep
# input :self, x, z(int), checked_list2(list)
# output :checked_list2
# creatde new list
