...
# def getAllAreaBordersInOrder
# input self
# output group_of_border_blocks
# get group_of_border_blocks
...
# def groupBorders
# input self,x, z(int)
# append group_of_boeder_blocks list
...
# def checkStep
# input :self, x, z(int)
#append checked_list,remove to next block
