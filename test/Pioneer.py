...
# def give_to_next
# input:self
# output:give_to_next_area_with_border
    def give_to_next(self):
        return self.give_to_next_area_with_border
# def findAreaToLevelling
# input:self
# output:gfloat(count_num) / float(self.width * self.height)
    ...
    def isBorder(self, x, z):
        ...
        for i in range(8):
            ...
            if 0 <= p_x < self.shape[0] and 0 <= p_z < self.shape[1]:
                ...
                return True
        return res
# def getValueFromArea
# input:self x, z(int)
# output:area_with_border or -1
# find out Value From Area
...
# check map
    def levelling(self):
        ...
        self.paving()
# def get_road_len
# input:self , r_x, width, (int)right_list,(list) d=1
# output:road_length
# get roda len
...
# def paving
# input:self 
# The very important part, the part that generates the building
    def paving(self):
        p_z = self.s_z
        river = 0
        road_width = 12
